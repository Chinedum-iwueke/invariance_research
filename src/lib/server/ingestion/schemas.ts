...
export const canonicalTradeSchema = z
  .object({
    ...
    r_multiple: z.number().finite().optional(),
    r_multiple_net: z.number().finite().optional(),
    r_multiple_gross: z.number().finite().optional(),
    risk_amount: z.number().finite().optional(),
    stop_distance: z.number().finite().optional(),
