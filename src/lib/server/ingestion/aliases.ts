...
export const baseTradeCsvAliasMap: TradeCsvAliasMap = {
  ...
  mae: ["mae", "mae_price", "max_adverse_excursion"],
  mfe: ["mfe", "mfe_price", "max_favorable_excursion"],
  r_multiple: ["r_multiple", "r", "r_value"],
  r_multiple_net: ["r_multiple_net"],
  r_multiple_gross: ["r_multiple_gross"],
  risk_amount: ["risk_amount", "risk", "risk_amt"],
  stop_distance: ["stop_distance", "entry_stop_distance", "stop_dist"],
