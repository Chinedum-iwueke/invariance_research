...
export function buildDiagnosticEligibility(
  ...
  if (richness === "trade_only") {
    return {
      ...
      distribution: { availability: "available" },
      monte_carlo: { availability: "available" },
      stability: { availability: "unavailable", reason: "requires parameter metadata" },
  ...
  return {
    ...
    distribution: { availability: "available" },
    monte_carlo: { availability: "available" },
    stability: { availability: context?.paramsPresent ? "available" : "limited", reason: context?.paramsPresent ? undefined : "requires parameter metadata" },
    execution: {
