    ...
    <AnalysisPageFrame title="Upgrade">
      <div className="grid gap-4 xl:grid-cols-2 2xl:grid-cols-4">
        ...
        <WorkspaceCard title="Pro" subtitle="$99/mo">
          <p className="text-sm text-text-neutral">Higher trade-history validation capacity, saved prop evaluation profiles, more shares, richer report appendices, and Expert Review eligibility.</p>
          <div className="pt-3">
