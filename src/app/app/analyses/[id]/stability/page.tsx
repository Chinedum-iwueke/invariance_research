...
export default function StabilityPage() {
  return (
    <AnalysisPageFrame title="Parameter Stability" description="Fragility diagnostics across parameter ranges and perturbations.">
      <WorkspaceCard title="Stability Surface" subtitle="Heatmap of parameter resilience">
      ...
      <InterpretationBlock body="Current stability indicates concentration around a narrow parameter island. Broader-range robustness testing is recommended before production deployment." />
